        ...
        <div class="container-fluid">
            <div class="board-title mb-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    @else
                        <h1 class="mb-0">Create New Proposal</h1>
                    @endif
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-card mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="subject" id="subject" class="form-control"
                                            placeholder="Enter Subject" value="{{ $proposal->subject ?? '' }}" required>
                                    </div>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="related" id="related" class="form-control" required>
                                            <option value="1" @if(($proposal->related ?? '') == '1') selected @endif>Lead
                                            </option>
                                            <option value="2" @if(($proposal->related ?? '') == '2') selected @endif>Client
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if(($proposal->related ?? '') == '2')
                                            <select name="lead_id" id="relatedList" class="form-control">
                                                ...
                                                @foreach($clients as $lead)
                                                    ...
                                                    <option value="{{ $lead->id ?? '' }}" data-name="{{ $lead->name ?? '' }}"
                                                        ...
                                                        data-email="{{ $lead->email ?? '' }}" data-mob="{{ $lead->mob ?? '' }}"
                                        ...
                                        @else
                                            <select name="lead_id" id="relatedList" class="selectpicker form-select"
                                ...
                                <div class="col-md-4 form-group">
                                    <label for="proposalDate" class="form-label">Proposal Date <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="currency" id="currency" class="form-control" required>
                                            <option value="INR" @if(($proposal->currency ?? '') == 'INR') selected @endif>₹
                                                INR</option>
                                            <option value="USD" @if(($proposal->currency ?? '') == 'USD') selected @endif>$
                                                USD</option>
                                            <option value="EUR" @if(($proposal->currency ?? '') == 'EUR') selected @endif>€
                                                EUR</option>
                                            <option value="GBP" @if(($proposal->currency ?? '') == 'GBP') selected @endif>£
                                                GBP</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4 form-group">
                                    <label for="discountType" class="form-label">Discount Applied On</label>
                                    <div class="input-group">
                                        ...
                                        <select name="discount_type" id="discountType" class="form-control">
                                            <option value="none" @if(($proposal->discount_type ?? '') == 'none') selected
                                            @endif>No discount</option>
                                            <option value="before-tax" @if(($proposal->discount_type ?? '') == 'before-tax')
                                            selected @endif>Before Tax</option>
                                            <option value="after-tax" @if(($proposal->discount_type ?? '') == 'after-tax')
                                            selected @endif>After Tax</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-8 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="tags" id="tags" class="form-control"
                                            placeholder="Enter Tags (comma separated)" value="{{ $proposal->tags ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-12 form-group">
                                    <label for="editor" class="form-label">Proposal Notes</label>
                                    <textarea name="notes" id="editor" class="form-control" rows="2"
                                        placeholder="Add proposal notes here...">{{ $proposal->notes ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-card mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4 form-group">
                                    <label for="clientName" class="form-label">Name <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class='bx bx-user'></i></span>
                                        <input type="text" name="client_name" id="clientName" class="form-control"
                                            placeholder="Enter Client Name" value="{{ $proposal->client_name ?? '' }}"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="client_email" id="clientEmail" class="form-control"
                                            placeholder="Enter Client Email" value="{{ $proposal->client_email ?? '' }}"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="tel" name="client_phone" id="clientPhone" class="form-control"
                                            placeholder="Enter Client Phone" value="{{ $proposal->client_phone ?? '91' }}">
                                    </div>
                                </div>
                                <div class="col-md-4 form-group">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="client_city" id="clientCity" class="form-control"
                                            placeholder="Enter Client City" value="{{ $proposal->client_city ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="client_state" id="clientState" class="form-control"
                                            placeholder="Enter State/Province" value="{{ $proposal->client_state ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="client_zip" id="clientZip" class="form-control"
                                            placeholder="Enter Zip/Postal Code" value="{{ $proposal->client_zip ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="client_country" id="clientCountry" class="form-control"
                                            placeholder="Enter Country" value="{{ $proposal->client_country ?? '' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive mb-3">
                                <table class="table table-bordered text-center mb-0" id="items-table">
                                    ...
                                    <tbody>
                                            ...
                                            @foreach($proposalItems as $k => $proposalItem)
                                                <tr data-item-row="0">
                                                    <td><textarea class="form-control item-name"
                                                            name="proposal_items[{{ $k }}][item_name]" placeholder="Item Name"
                                                            rows="1">{{ $proposalItem->item_name ?? '' }}</textarea></td>
                                                    <td><textarea class="form-control item-description"
                                                            name="proposal_items[{{ $k }}][description]" placeholder="Description"
                                                            rows="1">{{ $proposalItem->description ?? '' }}</textarea></td>
                                                    ...
                                                    <td><input type="number" class="form-control item-rate text-end"
                                                            name="proposal_items[{{ $k }}][rate]" placeholder="Rate"
                                                            value="{{ $proposalItem->rate ?? '' }}"></td>
                                                    <td>
                                                        <select class="form-control item-tax" multiple
                                                            name="proposal_items[{{ $k }}][tax_percentage][]" title="No Tax">
                                                            @foreach($taxes as $index => $tax)
                                                                @php $calTax = ($tax ?? 0) / 100; @endphp
                                                                @if($index == 0)
                                                                    <option value="{{ $index . ":" . $calTax }}"
                                                                        @if(($proposalItem->cgst_percent ?? '') == ($calTax ?? 0)) selected
                                                                        @endif>CGST {{ $tax ?? 0 }} %</option>
                                                                @elseif($index == 1)
                                                                    <option value="{{ $index . ":" . $calTax }}"
                                                                        @if(($proposalItem->sgst_percent ?? '') == ($calTax ?? 0)) selected
                                                                        @endif>SGST {{ $tax ?? 0 }} %</option>
                                                                @elseif($index == 2)
                                                                    <option value="{{ $index . ":" . $calTax }}"
                                                                        @if(($proposalItem->igst_percent ?? '') == ($calTax ?? 0)) selected
                                                                        @endif>IGST {{ $tax ?? 0 }} %</option>
                                                                @elseif($index == 3)
                                                                    <option value="{{ $index . ":" . $calTax }}" @if(($proposalItem->vat_percent ?? '') == ($calTax ?? 0)) selected @endif>VAT {{ $tax ?? 0 }} %
                                                                    </option>
                                                                @else
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-danger remove-item-btn"><i
                                        ...
                                        @else
                                            <tr data-item-row="0">
                                                <td><textarea class="form-control item-name" name="proposal_items[0][item_name]"
                                                        placeholder="Item Name" rows="1" required></textarea></td>
                                                <td><textarea class="form-control item-description"
                                                        name="proposal_items[0][description]" placeholder="Description"
                                                        rows="1"></textarea></td>
                                                <td><input type="number" class="form-control item-qty text-center"
                                                        name="proposal_items[0][quantity]" value="1" min="1"></td>
                                                <td><input type="number" class="form-control item-rate text-end"
                                                        name="proposal_items[0][rate]" placeholder="Rate" required></td>
                                                <td>
                                                    <select class="form-control item-tax" multiple
                                ...
                                <div class="col-md-6 offset-md-6">
                                    <div class="bg-light p-3 rounded shadow-sm">
                                        <div class="summary-box mb-2 d-flex justify-content-between align-items-center">
                                            ...
                                            <span id="sub-total"
                                                class="fw-bold fs-5">₹{{ $proposal->sub_total ?? 0.00 }}</span>
                                            <input type="hidden" name="sub_total" id="sub-total1"
                                                value="{{ $proposal->sub_total ?? 0.00 }}">
                                        </div>

                                        <div class="summary-box mb-2 d-flex justify-content-between align-items-center">
                                            <span>Discount (<span id="discount-type-display"
                                                    class="fst-italic text-muted">None</span>):</span>
                                            <div class="input-group input-group-sm w-50">
                                                <input type="number" class="form-control text-end"
                                                    name="discount_percentage" id="discountValue"
                                                    value="{{ $proposal->discount_percentage ?? 0 }}" placeholder="%"
                                                    step="0.01" min="0">
                                                <span class="input-group-text bg-white"
                                                    id="discount-total">₹{{ $proposal->discount_amount_calculated ?? 0.00 }}</span>
                                        ...
                                        <div
                                            class="summary-box mb-2 d-flex justify-content-between align-items-center text-muted small">
                                            <span>CGST:</span>
                                            <span id="cgst-total">₹{{ $proposal->cgst_total ?? 0.00 }}</span>
                                            <input type="hidden" name="cgst_total" id="cgst-total1"
                                                value="{{ $proposal->cgst_total ?? 0.00 }}">
                                        </div>
                                        <div
                                            class="summary-box mb-2 d-flex justify-content-between align-items-center text-muted small">
                                            <span>SGST:</span>
                                            <span id="sgst-total">₹{{ $proposal->sgst_total ?? 0.00 }}</span>
                                            <input type="hidden" name="sgst_total" id="sgst-total1"
                                                value="{{ $proposal->sgst_total ?? 0.00 }}">
                                        </div>
                                        <div
                                            class="summary-box mb-2 d-flex justify-content-between align-items-center text-muted small">
                                            <span>IGST:</span>
                                            <span id="igst-total">₹{{ $proposal->igst_total ?? 0.00 }}</span>
                                            <input type="hidden" name="igst_total" id="igst-total1"
                                                value="{{ $proposal->igst_total ?? 0.00 }}">
                                        </div>
                                        <div
                                            class="summary-box mb-2 d-flex justify-content-between align-items-center text-muted small">
                                            <span>VAT:</span>
                                            <span id="vat-total">₹{{ $proposal->vat_total ?? 0.00 }}</span>
                                            <input type="hidden" name="vat_total" id="vat-total1"
                                                value="{{ $proposal->vat_total ?? 0.00 }}">
                                        </div>

                                        <div class="summary-box mb-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="border-top pt-3 d-flex justify-content-between align-items-center">
                                            ...
                                            <strong id="total" class="fs-4 text-primary">₹0.00</strong>
