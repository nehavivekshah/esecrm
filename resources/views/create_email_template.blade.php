@extends('layout')
@section('title', 'Add Email Template - eseCRM')
...
<section class="task__section">
    ...
    <div class="container-fluid">
        <div class="board-title board-title-flex mb-2">
            <a href="{{ route('email-templates.index') }}" class="btn btn-primary btn-sm back-btn">
...
<!--<option value="proposals">Proposals</option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="event" class="form-control" placeholder="expiry / created / overdue" required>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="body" rows="8" class="form-control" placeholder="Write email content..." required></textarea>
                                </div>
                                        ...
                                        @else
                                            <div class="col-md-2">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <button type="button" class="btn btn-primary" id="add-day">
