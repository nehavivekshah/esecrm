                ...
                <div class="col-xl">
                    <div class="footer-newsletter">
                        <div class="footer-newsletter-content">
                            <h2 class="newsletter-title">Grow Faster With Our CRM Solution</h2>
                        </div>
                        <a href="tel:+919619775533" class="th-btn style-radius">
                            Call us : +91 9619775533
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="widget footer-widget">
                        <div class="th-widget-about">
                            ...
                            <p class="about-text">Ese crm is a leading CRM solution provider based in
                                Goregaon, Mumbai, dedicated to empowering businesses with intelligent customer
                                relationship management tools.</p>
                            <div class="th-social"> 
                                <a href="https://wa.me/+919619775533">
                    ...
                    <div class="widget widget_nav_menu footer-widget">
                        ...
                        <div class="menu-all-pages-container">
                            <ul class="menu">
                                ...
                                <li><a href="#features">Proposals</a></li>
                                <li><a href="#features">Leads</a></li>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="footer-widget">
                        ...
                        <div class="contact-detail">
                            <p class="text-white"><i class="fa-solid fa-location-dot"></i> R5, Asmi Industrial Complex,
                                Ram Mandir, Goregaon West, Mumbai- 400104,
                                Maharashtra, INDIA</p>
                            <a href="tel:+919619775533"><i class="fa-solid fa-phone"></i>+91 9619775533</a>
                            <a href="mailto:manoj@webbrella.com"><i
                                    class="fa-solid fa-envelope"></i>manoj@webbrella.com</a>
                        </div>
                    </div>
                </div>
            </div>
